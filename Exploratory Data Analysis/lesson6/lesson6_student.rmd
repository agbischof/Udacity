...
ggplot(diamonds, aes(carat, price)) + geom_point(color = "#F79420", alpha = 1/4) +
...
setwd('/Users/agibbs/code/Udacity/Exploratory Data Analysis/lesson6')
getwd()
